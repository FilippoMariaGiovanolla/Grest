<HTML>
<HEAD>
	<TITLE>Modifica dati squadra</TITLE>
</HEAD>
<BODY>
	<?php
		$host_name='localhost';
		...
		$i=0;
	?>
	<B><h3>Seleziona il colore della squadra di cui vuoi modificare i dati</h3></B>
	<FORM NAME="modifica" ACTION="ModificaSquadra2.php" METHOD="POST">
	      <TABLE BORDER="0">
		<TR>
			<TD>Colore</TD>
			<TD>
