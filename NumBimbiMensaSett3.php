<HTML>
<HEAD>
	<TITLE>Numero bambini a mensa terza settimana</TITLE>
</HEAD>
<BODY>
<?php
	$hostname='localhost';
	...
	$query="SELECT COUNT(*) 
		    FROM Bambini
		    WHERE IscrittoSett_3='si' AND Mensa='si' ";
	...
	if ($righe>0)
	  {
		echo("<TABLE BORDER='1' ALIGN='CENTER'
				<TR>
					<TD><B>Numero totale dei bambini che si fermano a mensa la terza settimana</B></TD>					
				</TR>");
