<HTML>
<HEAD>
	<TITLE>Numero bambini a mensa quarta settimana</TITLE>
</HEAD>
<BODY>
<?php
	$hostname='localhost';
	...
	$query="SELECT COUNT(*) 
		    FROM Bambini
		    WHERE IscrittoSett_4='si' AND Mensa='si' ";
	...
	if ($righe>0)
	  {
		echo("<TABLE BORDER='1' ALIGN='CENTER'
				<TR>
					<TD><B>Numero totale dei bambini che si fermano a mensa la quarta settimana</B></TD>					
				</TR>");
