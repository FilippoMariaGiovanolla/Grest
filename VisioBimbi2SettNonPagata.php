<HTML>
<HEAD>
	<TITLE>Bambini seconda settimana che non hanno ancora pagato</TITLE>
</HEAD>
<BODY>
<?php
	$hostname='localhost';
	...
	$query="SELECT Nome,Cognome
		    FROM Bambini
		    WHERE IscrittoSett_2='si' AND PagataSett_2='no'
	...
	if ($righe>0)
	  {
		echo("<H3><CENTER>Elenco dei bambini iscritti alla seconda settimana e non l'hanno ancora pagata</CENTER></H3>");
