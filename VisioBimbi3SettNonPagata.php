<HTML>
<HEAD>
	<TITLE>Bambini terza settimana che non hanno ancora pagato</TITLE>
</HEAD>
<BODY>
<?php
	$hostname='localhost';
	...
	if ($righe>0)
	  {
		echo("<H3><CENTER>Elenco dei bambini iscritti alla terza settimana e non l'hanno ancora pagata</CENTER></H3>");
