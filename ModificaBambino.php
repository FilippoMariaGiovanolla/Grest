...
<BODY>
	...
	/* è giusto non mettere addslashes qui, perché il dato arriva già con gli slash */ $nome_vecchio=$_POST["nome_vecchio"];
	/* è giusto non mettere addslashes qui, perché il dato arriva già con gli slash */ $cognome_vecchio=$_POST["cognome_vecchio"];
