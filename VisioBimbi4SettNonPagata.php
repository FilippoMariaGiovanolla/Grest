<HTML>
<HEAD>
	<TITLE>Bambini quarta settimana che non hanno ancora pagato</TITLE>
</HEAD>
<BODY>
<?php
	$hostname='localhost';
	...
	$query="SELECT Nome,Cognome
		    FROM Bambini
		    WHERE IscrittoSett_4='si' AND PagataSett_3='no'
	...
	if ($righe>0)
	  {
		echo("<H3><CENTER>Elenco dei bambini iscritti alla quarta settimana e non l'hanno ancora pagata</CENTER></H3>");
